        ...
        <div class="zoom_outers" rel="<?= $row->id ?>">
            <a href="javascript:void(0)" class="pin-img-link">
                ...
                <div class="isptop_social">
                    ...
                    <a href="javascript:void(0)"><img src="<?= base_url("assets/images/facebook_grey.png") ?>"  rel="<?php #echo $pin['Portfolio']['image'] ?>" class="fbsharebutton" id="fbsharebutton_img" onclick="facebook_count_share(<?php #echo $pin['Member']['id']?>)" /><a>
                    <a rel="<?= $row->member_id ?>"  class="goog_p_c" href="https://plus.google.com/share?url=<?php #echo HTTP_ROOT."img/portfolio/search/"?><?php #echo $pin['Portfolio']['image'];?>" title="Google+"  onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=500');return false;"><img class="so_google_img" src="<?= base_url("assets/images/google_grey.png") ?>"></a>
                    <a  rel="<?= $row->member_id ?>" class="pint_p_c" href="//pinterest.com/pin/create/button/?url=<?php #echo HTTP_ROOT?>Homes/index/&media=<?php #echo HTTP_ROOT."img/portfolio/search/"?><?php #echo $pin['Portfolio']['image'];?>&description=Wedding%20In%20Asia%3A%20<?php #echo $pin['Category']['title']; ?>%20in%20<?php #echo $pin['Member']['CountryLocation']['country_name']; ?>"" title="Pinterest" target="_blank" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=500');return false;"><img class="so_pint_img" src="<?= base_url("assets/images/pinterest_grey.png") ?>"></a>
