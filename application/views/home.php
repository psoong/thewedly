                            ...
                            <div class="zoom_outers" rel="<?= $row->id ?>">
                                ...
                                <div class="isptop_social">
                                    <?php if($row->pin_type == "image"): ?>
                                        ...
                                        <a href="javascript:void(0)"><img src="<?= base_url("assets/images/facebook_grey.png") ?>"  rel="<?= base_url("assets/images/portfolio/search/".$row->image) ?>" class="fbsharebutton" id="fbsharebutton_img" desc="<?php echo ucwords($member->business_name);?>" type="image" /><a>
