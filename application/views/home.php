                            ...
                            <div class="zoom_outers" rel="<?= $row->id ?>">
                                ...
                                <div class="isptop_social">
                                    <?php if($row->pin_type == "image"): ?>
                                        ...
                                        <a href="javascript:void(0)"><img src="<?= base_url("assets/images/facebook_grey.png") ?>"  rel="<?= urlencode(base_url("assets/images/portfolio/search/".$row->image)) ?>" class="fbsharebutton" id="fbsharebutton_img" desc="<?php echo ucwords($member->business_name);?>" type="image" /><a>
                                    ...
                                    <?php elseif($row->pin_type == "video"): ?>
                                        <?php if(strstr($row->video,"youtube.com")): ?>
                                            ...
                                            <a href="javascript:void(0)"><img src="<?= base_url("assets/images/facebook_grey.png") ?>"  rel="<?php echo $vid_arr[1] ?>" class="fbsharebutton" id="fbsharebutton_vid" type="youtube" /><a>
                                        ...
                                        <?php elseif(strstr($row->video,"vimeo.com")): ?>
                                            <?php $vid_arr = explode("/", $row->video); ?>
                                            <a hreflang="<?= $row->member_id ?>" logged_in="no" href="javascript:void(0)" class="pin_ad" rel='<?= $row->id ?>' title="Add to Album"><img class="so_add_img" src="<?= base_url("assets/images/add_grey.png") ?>"></a>
                                            <a href="javascript:void(0)"><img src="<?= base_url("assets/images/facebook_grey.png") ?>"  rel="<?php echo $vid_arr[1] ?>" class="fbsharebutton" id="fbsharebutton_vid_vimeo" type="vimeo" /><a>
