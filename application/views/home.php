                            ...
                            <div class="zoom_outers" rel="<?= $row->id ?>">
                                <a href="javascript:void(0)" class="pin-img-link">
                                    ...
                                    <div class="isptop_social">
                                        ...
                                        <a href="javascript:void(0)"><img src="<?= base_url("assets/images/facebook_grey.png") ?>"  rel="<?= base_url("assets/images/portfolio/search/".$row->image) ?>" class="fbsharebutton" id="fbsharebutton_img" desc="<?=$pin_to?>" /><a>
                                        <a rel="<?php #echo $pin['Member']['id']?>"  class="goog_p_c" href="https://plus.google.com/share?url=<?= base_url("assets/images/portfolio/search/".$row->image) ?>" title="Google+"  onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=500');return false;"><img class="so_google_img" src="<?= base_url("assets/images/google_grey.png") ?>"></a>
                                        <a  rel="<?php #echo $pin['Member']['id']?>" class="pint_p_c" href="//pinterest.com/pin/create/button/?url=<?= base_url("assets/images/portfolio/search/".$row->image) ?>&description=<?=$pin_to?>" title="Pinterest" target="_blank" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=500');return false;"><img class="so_pint_img" src="<?= base_url("assets/images/pinterest_grey.png") ?>"></a>
