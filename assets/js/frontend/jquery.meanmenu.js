        ...
        return this.each(function () {
            ...
            function showMeanMenu() {
                if (currentWidth <= meanScreenWidth) {
                	...
                	jQuery('.mean-container').prepend('<div class="mean-bar">'+extraHTML+'<a href="#nav" class="meanmenu-reveal" style="'+meanStyles+'">Show Navigation</a><nav class="mean-nav"></nav></div>');
